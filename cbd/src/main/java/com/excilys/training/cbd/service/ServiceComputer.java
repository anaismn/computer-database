...
public class ServiceComputer {
	...
	public static ArrayList<Computer> getAllComputers() throws DAOException, SQLException{
	...
	public static Computer getOneComputer(String nameSearched) throws SQLException{
		ArrayList<Computer> computers = new ArrayList<Computer>();
	...
	public static void updateComputer(String oldName, Computer updatedComputer) {
